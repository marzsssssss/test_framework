...
class TestAdminEntites():

    @pytest.mark.asyncio
    @allure.title('Test  GET /admin/entities/accounts/un_name')
    async def test_get_entites_account_list(self, base):
    ...
    async def test_post_accouts_adjust_balance(self,get_ewallet_id, base):
        base.logger.get().info('Test launch - POST /admin/entities/accounts/adjust-balance/')
        await base.admin_entities_api.post_entities_accouts_adjust_balance(get_ewallet_id)